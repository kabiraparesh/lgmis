...
<div class="nav-outer"> 
		...
		<div id="nav-right">
			...
			<div style="display: block; color: whitesmoke;vertical-align: central; padding: 10px; font-size: 14px;"><span><?php echo '<b>' . Yii::t('application', 'Financial Year: ') . '</b><u>' . Yii::app()->session['ccfyear']->fyear . '</u>';?></span></div>
			<div class="clear">&nbsp;</div>

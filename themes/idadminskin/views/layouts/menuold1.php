    ...
    $propertytaxajax = '
        $.ajax({
			...
			beforeSend: function(jqXHR, settings){
                $("#dialog").html("'. Yii::t('application','Please wait... <br/>Property Tax generating for financial year {fyear}.', array('{fyear}'=>Yii::app()->session['ccfyear']->fyear)) .'");
                $("#dialog").dialog("option", "title", "'. Yii::t('application','Generating Property Tax') .'");
                $("#dialog").dialog("option", "height", "100");
                $("#dialog").dialog("option", "width", "300");		
				$( "#dialog" ).dialog({

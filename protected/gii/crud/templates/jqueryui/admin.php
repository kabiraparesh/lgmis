...
?>
$this->menu=array(
//	array('label'=>Yii::t('application', 'List {title}', array('{title}'=>Yii::t('application', '<?php echo strtolower($this->modelClass); ?>'))), 'url'=>array('index')),
	array('label'=>Yii::t('application', 'Create {title}', array('{title}'=>Yii::t('application', '<?php echo strtolower($this->modelClass); ?>'))), 'url'=>array('create')),
);
...
<?php echo "                             \$(\"#dialog\").dialog(\"option\", \"title\", \"'. Yii::t('application', 'Create {title}', array('{title}'=>Yii::t('application', '".strtolower($this->modelClass)."'))) .'\");\n"; ?>
...
<?php echo "                                  success: function(data){\n"; ?>
<?php echo "                                     \$(\"#dialog\").html(data);\n"; ?>
<?php echo "                                     \$(\"#dialog\").dialog(\"option\", \"title\", \"'. Yii::t('application','Update {title}', array('{title}'=>Yii::t('application', '".strtolower($this->modelClass)."'))) .' - \" + \$.fn.yiiGridView.getSelection(\"".strtolower($this->modelClass)."-grid\"));\n"; ?>
<?php echo "                                     \$(\"#dialog\").dialog(\"option\", \"height\", \"auto\");\n"; ?>
<?php echo "                                     \$(\"#dialog\").dialog(\"option\", \"width\", \"auto\");\n"; ?>
<?php echo "                                     \$(\"#dialog\").dialog(\"open\"); \n"; ?>
<?php echo "                                     return false;\n"; ?>
...
<?php echo "                              success: function(data){\n"; ?>
<?php echo "                                \$(\"#dialog\").html(data);\n"; ?>
<?php echo "                                \$(\"#dialog\").dialog(\"option\", \"title\", \"'. Yii::t('application','View {title}', array('{title}'=>Yii::t('application', '".strtolower($this->modelClass)."'))) .' - \" + \$.fn.yiiGridView.getSelection(\"".strtolower($this->modelClass)."-grid\"));\n"; ?>
<?php echo "                                \$(\"#dialog\").dialog(\"option\", \"height\", \"auto\");\n"; ?>
<?php echo "                                \$(\"#dialog\").dialog(\"option\", \"width\", \"auto\");\n"; ?>
<?php echo "                                \$(\"#dialog\").dialog(\"open\"); \n"; ?>
<?php echo "                                return false;\n"; ?>
...
<?php echo "<?php"; ?> $this->widget('ext.eziiui.widgets.grid.CGridViewUI', array(
	...
	'filter'=>$model,
        ...
        <?php echo "\"template\" => \"{summary}{items}<div class='ui-widget-header ui-corner-bottom' style='width:100%; float:left;'><div style='float:left;'>\" .\n"; ?>
        <?php echo "\$pagertoolbox .\n"; ?>

...
//	public $layout='//layouts/column2';
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['<?php echo $this->modelClass; ?>']))
		{
			...
			if($model->save())
                                $this->redirect(array('create', 'id' => $model-><?php echo $this->tableSchema->primaryKey; ?>));
    ...
    $columns[] = $column;
        ...
        public function actionJsonmessage() {
            ...
            if(isset ($_REQUEST['cid'])){
                $model=<?php echo $this->modelClass; ?>::model()->findByPk($_REQUEST['cid']);
                if($model){
                    $jsonmessage['message'] = $model-><?php echo $columns[1]->name; ?> ;
                }
            }

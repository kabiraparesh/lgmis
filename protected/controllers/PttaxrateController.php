...
class PttaxrateController extends Controller
{
	/**
...
//        public $layout = '//layouts/eastsouthwest';
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Pttaxrate']))
		{
			$model->attributes=$_POST['Pttaxrate'];
                        $status = 'Failure';
                        if ($model->save()) {
                            $status = 'Success';
                        }
	...
	{
		$dataProvider=new CActiveDataProvider('Pttaxrate');
	...
	{
		$model=new Pttaxrate('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Pttaxrate']))
			$model->attributes=$_GET['Pttaxrate'];
	...
	{
		$model=Pttaxrate::model()->findByPk((int)$id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='pttaxrate-form')
		{
        ...
        public function actionJsonmessage() {
            ...
            if(isset ($_REQUEST['cid'])){
                $model=Pttaxrate::model()->findByPk($_REQUEST['cid']);
                if($model){
                    $jsonmessage['message'] = $model->permanentdiscount ;
                }
            }

...
class PtrangeController extends Controller
{
	/**
...
//        public $layout = '//layouts/eastsouthwest';
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Ptrange']))
		{
			$model->attributes=$_POST['Ptrange'];
                        $status = 'Failure';
                        if ($model->save()) {
                            $status = 'Success';
                        }
	...
	{
		$dataProvider=new CActiveDataProvider('Ptrange');
	...
	{
		$model=new Ptrange('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Ptrange']))
			$model->attributes=$_GET['Ptrange'];
	...
	{
		$model=Ptrange::model()->findByPk((int)$id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='ptrange-form')
		{
        ...
        public function actionJsonmessage() {
            ...
            if(isset ($_REQUEST['cid'])){
                $model=Ptrange::model()->findByPk($_REQUEST['cid']);
                if($model){
                    $jsonmessage['message'] = $model->rangeno ;
                }
            }

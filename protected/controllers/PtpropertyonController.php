...
class PtpropertyonController extends Controller
{
	/**
...
//        public $layout = '//layouts/eastsouthwest';
	...
	{
		$model=new Ptpropertyon;

		// Uncomment the following line if AJAX validation is needed
		$this->performAjaxValidation($model);

		if(isset($_POST['Ptpropertyon']))
		{
			$model->attributes=$_POST['Ptpropertyon'];
                        $status = 'Failure';
                        if ($model->save()) {
                            $status = 'Success';
                        }
	...
	{
		$dataProvider=new CActiveDataProvider('Ptpropertyon');
	...
	{
		$model=new Ptpropertyon('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Ptpropertyon']))
			$model->attributes=$_GET['Ptpropertyon'];
	...
	{
		$model=Ptpropertyon::model()->findByPk((int)$id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='ptpropertyon-form')
		{
        ...
        public function actionJsonmessage() {
            ...
            if(isset ($_REQUEST['cid'])){
                $model=Ptpropertyon::model()->findByPk($_REQUEST['cid']);
                if($model){
                    $jsonmessage['message'] = $model->propertyon ;
                }
            }

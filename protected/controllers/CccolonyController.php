...
class CccolonyController extends Controller
{
	/**
...
//        public $layout = '//layouts/eastsouthwest';
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Cccolony']))
		{
			$model->attributes=$_POST['Cccolony'];
                        $status = 'Failure';
                        if ($model->save()) {
                            $status = 'Success';
                        }
	...
	{
		$dataProvider=new CActiveDataProvider('Cccolony');
	...
	{
		$model=new Cccolony('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Cccolony']))
			$model->attributes=$_GET['Cccolony'];
	...
	{
		$model=Cccolony::model()->findByPk((int)$id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='cccolony-form')
		{
        ...
        public function actionJsonmessage() {
            ...
            if(isset ($_REQUEST['cid'])){
                $model=Cccolony::model()->findByPk($_REQUEST['cid']);
                if($model){

...
class PtexsumptorController extends Controller
{
	/**
...
//        public $layout = '//layouts/eastsouthwest';
	...
	{
		$model=new Ptexsumptor;

		// Uncomment the following line if AJAX validation is needed
		$this->performAjaxValidation($model);

		if(isset($_POST['Ptexsumptor']))
		{
			$model->attributes=$_POST['Ptexsumptor'];
                        $status = 'Failure';
                        if ($model->save()) {
                            $status = 'Success';
                        }
	...
	{
		$dataProvider=new CActiveDataProvider('Ptexsumptor');
	...
	{
		$model=new Ptexsumptor('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Ptexsumptor']))
			$model->attributes=$_GET['Ptexsumptor'];
	...
	{
		$model=Ptexsumptor::model()->findByPk((int)$id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='ptexsumptor-form')
		{
        ...
        public function actionJsonmessage() {
            ...
            if(isset ($_REQUEST['cid'])){
                $model=Ptexsumptor::model()->findByPk($_REQUEST['cid']);
                if($model){

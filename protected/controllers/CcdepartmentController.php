...
class CcdepartmentController extends Controller
{
	/**
...
//        public $layout = '//layouts/eastsouthwest';
	...
	{
		$model=new Ccdepartment;

		// Uncomment the following line if AJAX validation is needed
		$this->performAjaxValidation($model);

		if(isset($_POST['Ccdepartment']))
		{
			$model->attributes=$_POST['Ccdepartment'];
                        $status = 'Failure';
                        if ($model->save()) {
                            $status = 'Success';
                        }
	...
	{
		$dataProvider=new CActiveDataProvider('Ccdepartment');
	...
	{
		$model=new Ccdepartment('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Ccdepartment']))
			$model->attributes=$_GET['Ccdepartment'];
	...
	{
		$model=Ccdepartment::model()->findByPk((int)$id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='ccdepartment-form')
		{
        ...
        public function actionJsonmessage() {
            ...
            if(isset ($_REQUEST['cid'])){
                $model=Ccdepartment::model()->findByPk($_REQUEST['cid']);
                if($model){
                    $jsonmessage['message'] = $model->departmentname ;
                }
            }

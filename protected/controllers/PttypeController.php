...
//        public $layout = '//layouts/eastsouthwest';
	...
	{
		$dataProvider=new CActiveDataProvider('Pttype');
	...
	{
		$model=new Pttype('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Pttype']))
			$model->attributes=$_GET['Pttype'];
	...
	{
		$model=Pttype::model()->findByPk((int)$id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='pttype-form')
		{
        ...
        public function actionJsonmessage() {
            ...
            if(isset ($_REQUEST['cid'])){
                $model=Pttype::model()->findByPk($_REQUEST['cid']);
                if($model){

...
class PtservicetaxController extends Controller
{
	/**
...
//        public $layout = '//layouts/eastsouthwest';
	...
	{
		$model=new Ptservicetax;

		// Uncomment the following line if AJAX validation is needed
		$this->performAjaxValidation($model);

		if(isset($_POST['Ptservicetax']))
		{
			$model->attributes=$_POST['Ptservicetax'];
                        $status = 'Failure';
                        if ($model->save()) {
                            $status = 'Success';
                        }
	...
	{
		$dataProvider=new CActiveDataProvider('Ptservicetax');
	...
	{
		$model=new Ptservicetax('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Ptservicetax']))
			$model->attributes=$_GET['Ptservicetax'];
	...
	{
		$model=Ptservicetax::model()->findByPk((int)$id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='ptservicetax-form')
		{
        ...
        public function actionJsonmessage() {
            ...
            if(isset ($_REQUEST['cid'])){
                $model=Ptservicetax::model()->findByPk($_REQUEST['cid']);
                if($model){
                    $jsonmessage['message'] = $model->servicetype ;
                }
            }

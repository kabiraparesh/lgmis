...
class CcwardController extends Controller
{
	/**
...
//        public $layout = '//layouts/eastsouthwest';
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Ccward']))
		{
			$model->attributes=$_POST['Ccward'];
                        $status = 'Failure';
                        if ($model->save()) {
                            $status = 'Success';
                        }
	...
	{
		$dataProvider=new CActiveDataProvider('Ccward');
	...
	{
		$model=new Ccward('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Ccward']))
			$model->attributes=$_GET['Ccward'];
	...
	{
		$model=Ccward::model()->findByPk((int)$id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='ccward-form')
		{
        ...
        public function actionJsonmessage() {
            ...
            if(isset ($_REQUEST['cid'])){
                $model=Ccward::model()->findByPk($_REQUEST['cid']);
                if($model){
                    $jsonmessage['message'] = $model->wardname ;
                }
            }

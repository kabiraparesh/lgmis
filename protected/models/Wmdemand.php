...
class Wmdemand extends CActiveRecord
{
	...
	{
		return array(
			'idwmdemand' => Yii::t('application', 'Idwmdemand'),
			'idwmmaster' => Yii::t('application', 'Idwmmaster'),
			'idccfyear' => Yii::t('application', 'Idccfyear'),
			'idccmonth' => Yii::t('application', 'Idccmonth'),
			'wmoldbalance' => Yii::t('application', 'Wmoldbalance'),
			'wmsurcharge' => Yii::t('application', 'Wmsurcharge'),
			'wmdemandamt' => Yii::t('application', 'Wmdemandamt'),
			'wmdemanddate' => Yii::t('application', 'Wmdemanddate'),
		);
	}

...
$this->setPageTitle(Yii::t('application', 'Rpdemandreceipt'));
?>
<?php
$this->menu=array(
...
$('.rpdemandreceipt-search-button').click(function(){
	$('.rpdemandreceipt-search-form').toggle();
	return false;
});
$('.rpdemandreceipt-search-form form').submit(function(){
...
<?php echo CHtml::link(Yii::t('application', 'Advanced Search'),'#',array('class'=>'rpdemandreceipt-search-button')); ?>
<div class="rpdemandreceipt-search-form" style="display:none">
...
$pagertoolbox .= CHtml::link(
        ...
        $htmlOptions = array(
            ...
            'onclick' => '$.fn.yiiGridView.update("rpdemandreceipt-grid", {
		data: $(this).serialize()
            });'
            ));
$pagertoolbox .= "</td>";
                    ...
                    'onclick' => '
                        $.ajax({
                          ...
                          success: function(data){
                             $("#dialog").html(data);
                             $("#dialog").dialog("option", "title", "'. Yii::t('application', 'Create {title}', array('{title}'=>Yii::t('application', 'rpdemandreceipt'))) .'");
...
$pagertoolbox .= CHtml::link(
                ...
                $htmlOptions = array(
                    'onclick' => '
                          if($.fn.yiiGridView.getSelection("rpdemandreceipt-grid") != ""){
                                $.ajax({
                                  url: "'.Yii::app()->createUrl('lgmisRental/rpdemandreceipt/update').'&isAjaxRequest=1&id=" + $.fn.yiiGridView.getSelection("rpdemandreceipt-grid"),
                                  success: function(data){
                                     $("#dialog").html(data);
                                     $("#dialog").dialog("option", "title", "'. Yii::t('application','Update {title}', array('{title}'=>Yii::t('application', 'rpdemandreceipt'))) .' - " + $.fn.yiiGridView.getSelection("rpdemandreceipt-grid"));
                                     $("#dialog").dialog("option", "height", "auto");
                                     $("#dialog").dialog("option", "width", "auto");
                                     $("#dialog").dialog("open"); 
                                     return false;
...
$pagertoolbox .= CHtml::link("<div class='ui-pg-div'><span class='ui-icon ui-icon-trash'></span></div>", '#', array(
            ...
            'onclick'=>'
                    if($.fn.yiiGridView.getSelection("rpdemandreceipt-grid") != ""){
                        ...
                        window.url = "'. CController::createUrl('lgmisRental/rpdemandreceipt/delete').'";
...
$pagertoolbox .= CHtml::link(
                ...
                $htmlOptions = array(
                    'onclick' => '
                        if($.fn.yiiGridView.getSelection("rpdemandreceipt-grid") != ""){
                            $.ajax({
                              url: "'.Yii::app()->createUrl('lgmisRental/rpdemandreceipt/view').'&isAjaxRequest=1&id=" + $.fn.yiiGridView.getSelection("rpdemandreceipt-grid"),
                              success: function(data){
                                $("#dialog").html(data);
                                $("#dialog").dialog("option", "title", "'. Yii::t('application','View {title}', array('{title}'=>Yii::t('application', 'rpdemandreceipt'))) .' - " + $.fn.yiiGridView.getSelection("rpdemandreceipt-grid"));
                                $("#dialog").dialog("option", "height", "auto");
                                $("#dialog").dialog("option", "width", "auto");
                                $("#dialog").dialog("open"); 
                                return false;

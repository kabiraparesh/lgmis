...
$this->setPageTitle(Yii::t('application', 'Rptenant'));
?>
<?php
$this->menu=array(
...
$('.rptenant-search-button').click(function(){
	$('.rptenant-search-form').toggle();
	return false;
});
$('.rptenant-search-form form').submit(function(){
...
<?php echo CHtml::link(Yii::t('application', 'Advanced Search'),'#',array('class'=>'rptenant-search-button')); ?>
<div class="rptenant-search-form" style="display:none">
...
$pagertoolbox .= CHtml::link(
        ...
        $htmlOptions = array(
            ...
            'onclick' => '$.fn.yiiGridView.update("rptenant-grid", {
		data: $(this).serialize()
            });'
            ));
$pagertoolbox .= "</td>";
...
$pagertoolbox .= CHtml::link(
                ...
                $htmlOptions = array(
                    ...
                    'onclick' => '
                        $.ajax({
                          url: "'.Yii::app()->createUrl('lgmisRental/rptenant/create').'&isAjaxRequest=1",
...
$pagertoolbox .= CHtml::link(
                ...
                $htmlOptions = array(
                    'onclick' => '
                          if($.fn.yiiGridView.getSelection("rptenant-grid") != ""){
                                $.ajax({
                                  url: "'.Yii::app()->createUrl('lgmisRental/rptenant/update').'&isAjaxRequest=1&id=" + $.fn.yiiGridView.getSelection("rptenant-grid"),
                                  success: function(data){
                                     $("#dialog").html(data);
                                     $("#dialog").dialog("option", "title", "'. Yii::t('application','Update {title}', array('{title}'=>Yii::t('application', 'rptenant'))) .' - " + $.fn.yiiGridView.getSelection("rptenant-grid"));
                                     $("#dialog").dialog("option", "height", "auto");
                                     $("#dialog").dialog("option", "width", "auto");
                                     $("#dialog").dialog("open"); 
                                     return false;
...
$pagertoolbox .= CHtml::link("<div class='ui-pg-div'><span class='ui-icon ui-icon-trash'></span></div>", '#', array(
            ...
            'onclick'=>'
                    if($.fn.yiiGridView.getSelection("rptenant-grid") != ""){
                        window.cid = "rptenant";
                        window.url = "'. CController::createUrl('lgmisRental/rptenant/delete').'";
...
$pagertoolbox .= CHtml::link(
                ...
                $htmlOptions = array(
                    'onclick' => '
                        if($.fn.yiiGridView.getSelection("rptenant-grid") != ""){
                            $.ajax({
                              url: "'.Yii::app()->createUrl('lgmisRental/rptenant/view').'&isAjaxRequest=1&id=" + $.fn.yiiGridView.getSelection("rptenant-grid"),
                              success: function(data){
                                $("#dialog").html(data);
                                $("#dialog").dialog("option", "title", "'. Yii::t('application','View {title}', array('{title}'=>Yii::t('application', 'rptenant'))) .' - " + $.fn.yiiGridView.getSelection("rptenant-grid"));
                                $("#dialog").dialog("option", "height", "auto");
                                $("#dialog").dialog("option", "width", "auto");
                                $("#dialog").dialog("open"); 
                                return false;

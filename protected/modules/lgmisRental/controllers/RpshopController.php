...
class RpshopController extends Controller
{
	/**
...
//        public $layout = '//layouts/eastsouthwest';
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Rpshop']))
		{
			$model->attributes=$_POST['Rpshop'];
                        $status = 'Failure';
                        if ($model->save()) {
                            $status = 'Success';
                        }
	...
	{
		$dataProvider=new CActiveDataProvider('Rpshop');
	...
	{
		$model=new Rpshop('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Rpshop']))
			$model->attributes=$_GET['Rpshop'];
	...
	{
		$model=Rpshop::model()->findByPk((int)$id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='rpshop-form')
		{
        ...
        public function actionJsonmessage() {
            ...
            if(isset ($_REQUEST['cid'])){
                $model=Rpshop::model()->findByPk($_REQUEST['cid']);
                if($model){
                    $jsonmessage['message'] = $model->shopno ;
                }
            }

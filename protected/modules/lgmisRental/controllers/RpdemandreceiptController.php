...
class RpdemandreceiptController extends Controller
{
	/**
...
//        public $layout = '//layouts/eastsouthwest';
	...
	{
		$model=new Rpdemandreceipt;

		// Uncomment the following line if AJAX validation is needed
		$this->performAjaxValidation($model);

		if(isset($_POST['Rpdemandreceipt']))
		{
			$model->attributes=$_POST['Rpdemandreceipt'];
                        $status = 'Failure';
                        if ($model->save()) {
                            $status = 'Success';
                        }
	...
	{
		$dataProvider=new CActiveDataProvider('Rpdemandreceipt');
	...
	{
		$model=new Rpdemandreceipt('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Rpdemandreceipt']))
			$model->attributes=$_GET['Rpdemandreceipt'];
	...
	{
		$model=Rpdemandreceipt::model()->findByPk((int)$id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='rpdemandreceipt-form')
		{
        ...
        public function actionJsonmessage() {
            ...
            if(isset ($_REQUEST['cid'])){
                $model=Rpdemandreceipt::model()->findByPk($_REQUEST['cid']);
                if($model){

...
class RprangeController extends Controller
{
	/**
...
//        public $layout = '//layouts/eastsouthwest';
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Rprange']))
		{
			$model->attributes=$_POST['Rprange'];
                        $status = 'Failure';
                        if ($model->save()) {
                            $status = 'Success';
                        }
	...
	{
		$dataProvider=new CActiveDataProvider('Rprange');
	...
	{
		$model=new Rprange('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Rprange']))
			$model->attributes=$_GET['Rprange'];
	...
	{
		$model=Rprange::model()->findByPk((int)$id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='rprange-form')
		{
        ...
        public function actionJsonmessage() {
            ...
            if(isset ($_REQUEST['cid'])){
                $model=Rprange::model()->findByPk($_REQUEST['cid']);
                if($model){
                    $jsonmessage['message'] = $model->rangetype ;
                }
            }

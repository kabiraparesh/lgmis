 ...
 * @property Rpdemandreceipt[] $rpdemandreceipts
 */
class Rpdemand extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('idrpshop, idccfyear, period', 'required'),
			...
			array('idrpdemand, idrpshop, idccfyear, period, rpoldbalance, rpsurcharge, rpdemandamt, rpdemanddate', 'safe', 'on'=>'search'),
                        array('idrpshop, idccfyear', 'validatefkeys'),
		);
	}        
	...
	public function relations()
	{
		...
		return array(
			...
			'rpdemandreceipts' => array(self::HAS_MANY, 'Rpdemandreceipt', 'idrpdemand'),
		);
	}

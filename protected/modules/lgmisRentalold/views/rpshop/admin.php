...
$pagertoolbox .= CHtml::link("<div class='ui-pg-div'><span class='ui-icon ui-icon-trash'></span></div>", '#', array(
            ...
            'onclick'=>'
                    if($.fn.yiiGridView.getSelection("rpshop-grid") != ""){
                        window.cid = "rpshop";
                        window.url = "'. CController::createUrl('rpshop/delete').'";
...
$pagertoolbox .= "<td>";
$pagertoolbox .= CHtml::link(
                "<div class='ui-pg-div'><span style='font-size: smaller'>&nbsp;&nbsp;&nbsp;" . Yii::t('application', 'Tenant') . "&nbsp;&nbsp;&nbsp;</span>", 
                "#",
                $htmlOptions = array(
                    'title' => Yii::t('application', 'Tanent'),
                    'onclick' => '
                          if($.fn.yiiGridView.getSelection("rpshop-grid") != ""){
                          //alert($.fn.yiiGridView.getSelection("rpshop-grid"));
                         
                             //window.location.href="'.Yii::app()->createUrl('lgmisRental/rptenant/admin').'&id=" + $.fn.yiiGridView.getSelection("rpshop-grid");
                              
                                $.ajax({
                                  url: "'.Yii::app()->createUrl('lgmisRental/rptenant/update').'&isAjaxRequest=1&id=" + $.fn.yiiGridView.getSelection("rpshop-grid"),
                                  success: function(data){
                                     $("#dialog").html(data);
                                     $("#dialog").dialog("option", "title", "'. Yii::t('application','Update {title}', array('{title}'=>Yii::t('application', 'rpshop'))) .' - " + $.fn.yiiGridView.getSelection("ssapplication-grid"));
                                     $("#dialog").dialog("option", "height", "auto");
                                     $("#dialog").dialog("option", "width", "auto");
                                     $("#dialog").dialog("open"); 
                                     return false;

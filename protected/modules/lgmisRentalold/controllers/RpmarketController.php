...
class RpmarketController extends Controller
{
	/**
...
//        public $layout = '//layouts/eastsouthwest';
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Rpmarket']))
		{
			$model->attributes=$_POST['Rpmarket'];
                        $status = 'Failure';
                        if ($model->save()) {
                            $status = 'Success';
                        }
	...
	{
		$dataProvider=new CActiveDataProvider('Rpmarket');
	...
	{
		$model=new Rpmarket('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Rpmarket']))
			$model->attributes=$_GET['Rpmarket'];
	...
	{
		$model=Rpmarket::model()->findByPk((int)$id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='rpmarket-form')
		{
        ...
        public function actionJsonmessage() {
            ...
            if(isset ($_REQUEST['cid'])){
                $model=Rpmarket::model()->findByPk($_REQUEST['cid']);
                if($model){
                    $jsonmessage['message'] = $model->mktname ;
                }
            }

...
class HrleavesettingController extends Controller
{
	/**
...
//        public $layout = '//layouts/eastsouthwest';
	...
	{
		$model=new Hrleavesetting;

		// Uncomment the following line if AJAX validation is needed
		$this->performAjaxValidation($model);

		if(isset($_POST['Hrleavesetting']))
		{
			$model->attributes=$_POST['Hrleavesetting'];
                        $status = 'Failure';
                        if ($model->save()) {
                            $status = 'Success';
                        }
	...
	{
		$dataProvider=new CActiveDataProvider('Hrleavesetting');
	...
	{
		$model=new Hrleavesetting('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Hrleavesetting']))
			$model->attributes=$_GET['Hrleavesetting'];
	...
	{
		$model=Hrleavesetting::model()->findByPk((int)$id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='hrleavesetting-form')
		{
        ...
        public function actionJsonmessage() {
            ...
            if(isset ($_REQUEST['cid'])){
                $model=Hrleavesetting::model()->findByPk($_REQUEST['cid']);
                if($model){
                    $jsonmessage['message'] = $model->casualleave ;
                }
            }

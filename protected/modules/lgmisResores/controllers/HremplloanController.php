...
class HremplloanController extends Controller
{
	/**
...
//        public $layout = '//layouts/eastsouthwest';
	...
	{
		$model=new Hremplloan;

		// Uncomment the following line if AJAX validation is needed
		$this->performAjaxValidation($model);

		if(isset($_POST['Hremplloan']))
		{
			$model->attributes=$_POST['Hremplloan'];
                        $status = 'Failure';
                        if ($model->save()) {
                            $status = 'Success';
                        }
	...
	{
		$dataProvider=new CActiveDataProvider('Hremplloan');
	...
	{
		$model=new Hremplloan('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Hremplloan']))
			$model->attributes=$_GET['Hremplloan'];
	...
	{
		$model=Hremplloan::model()->findByPk((int)$id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='hremplloan-form')
		{
        ...
        public function actionJsonmessage() {
            ...
            if(isset ($_REQUEST['cid'])){
                $model=Hremplloan::model()->findByPk($_REQUEST['cid']);
                if($model){

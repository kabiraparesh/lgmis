...
class HremplinsuranceController extends Controller
{
	/**
...
//        public $layout = '//layouts/eastsouthwest';
	...
	{
		$model=new Hremplinsurance;

		// Uncomment the following line if AJAX validation is needed
		$this->performAjaxValidation($model);

		if(isset($_POST['Hremplinsurance']))
		{
			$model->attributes=$_POST['Hremplinsurance'];
                        $status = 'Failure';
                        if ($model->save()) {
                            $status = 'Success';
                        }
	...
	{
		$dataProvider=new CActiveDataProvider('Hremplinsurance');
	...
	{
		$model=new Hremplinsurance('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Hremplinsurance']))
			$model->attributes=$_GET['Hremplinsurance'];
	...
	{
		$model=Hremplinsurance::model()->findByPk((int)$id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='hremplinsurance-form')
		{
        ...
        public function actionJsonmessage() {
            ...
            if(isset ($_REQUEST['cid'])){
                $model=Hremplinsurance::model()->findByPk($_REQUEST['cid']);
                if($model){

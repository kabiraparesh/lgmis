...
class HremplearnleaveController extends Controller
{
	/**
...
//        public $layout = '//layouts/eastsouthwest';
	...
	{
		$model=new Hremplearnleave;

		// Uncomment the following line if AJAX validation is needed
		$this->performAjaxValidation($model);

		if(isset($_POST['Hremplearnleave']))
		{
			$model->attributes=$_POST['Hremplearnleave'];
                        $status = 'Failure';
                        if ($model->save()) {
                            $status = 'Success';
                        }
	...
	{
		$dataProvider=new CActiveDataProvider('Hremplearnleave');
	...
	{
		$model=new Hremplearnleave('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Hremplearnleave']))
			$model->attributes=$_GET['Hremplearnleave'];
	...
	{
		$model=Hremplearnleave::model()->findByPk((int)$id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='hremplearnleave-form')
		{
        ...
        public function actionJsonmessage() {
            ...
            if(isset ($_REQUEST['cid'])){
                $model=Hremplearnleave::model()->findByPk($_REQUEST['cid']);
                if($model){

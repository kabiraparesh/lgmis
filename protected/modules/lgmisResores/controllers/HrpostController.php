...
//        public $layout = '//layouts/eastsouthwest';
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Hrpost']))
		{
			$model->attributes=$_POST['Hrpost'];
                        $status = 'Failure';
                        if ($model->save()) {
                            $status = 'Success';
                        }
	...
	{
		$dataProvider=new CActiveDataProvider('Hrpost');
	...
	{
		$model=new Hrpost('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Hrpost']))
			$model->attributes=$_GET['Hrpost'];
	...
	{
		$model=Hrpost::model()->findByPk((int)$id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='hrpost-form')
		{
        ...
        public function actionJsonmessage() {
            ...
            if(isset ($_REQUEST['cid'])){
                $model=Hrpost::model()->findByPk($_REQUEST['cid']);
                if($model){
                    $jsonmessage['message'] = $model->postname ;
                }
            }

...
class HremplmemberController extends Controller
{
	/**
...
//        public $layout = '//layouts/eastsouthwest';
	...
	{
		$model=new Hremplmember;

		// Uncomment the following line if AJAX validation is needed
		$this->performAjaxValidation($model);

		if(isset($_POST['Hremplmember']))
		{
			$model->attributes=$_POST['Hremplmember'];
                        $status = 'Failure';
                        if ($model->save()) {
                            $status = 'Success';
                        }
	...
	{
		$dataProvider=new CActiveDataProvider('Hremplmember');
	...
	{
		$model=new Hremplmember('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Hremplmember']))
			$model->attributes=$_GET['Hremplmember'];
	...
	{
		$model=Hremplmember::model()->findByPk((int)$id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='hremplmember-form')
		{
        ...
        public function actionJsonmessage() {
            ...
            if(isset ($_REQUEST['cid'])){
                $model=Hremplmember::model()->findByPk($_REQUEST['cid']);
                if($model){
                    $jsonmessage['message'] = $model->membername ;
                }
            }

...
class HrempleducationController extends Controller
{
	/**
...
//        public $layout = '//layouts/eastsouthwest';
	...
	{
		$model=new Hrempleducation;

		// Uncomment the following line if AJAX validation is needed
		$this->performAjaxValidation($model);

		if(isset($_POST['Hrempleducation']))
		{
			$model->attributes=$_POST['Hrempleducation'];
                        $status = 'Failure';
                        if ($model->save()) {
                            $status = 'Success';
                        }
	...
	{
		$dataProvider=new CActiveDataProvider('Hrempleducation');
	...
	{
		$model=new Hrempleducation('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Hrempleducation']))
			$model->attributes=$_GET['Hrempleducation'];
	...
	{
		$model=Hrempleducation::model()->findByPk((int)$id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='hrempleducation-form')
		{
        ...
        public function actionJsonmessage() {
            ...
            if(isset ($_REQUEST['cid'])){
                $model=Hrempleducation::model()->findByPk($_REQUEST['cid']);
                if($model){

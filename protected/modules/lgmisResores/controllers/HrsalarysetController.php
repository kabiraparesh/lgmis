...
class HrsalarysetController extends Controller
{
	/**
...
//        public $layout = '//layouts/eastsouthwest';
	...
	{
		$model=new Hrsalaryset;

		// Uncomment the following line if AJAX validation is needed
		$this->performAjaxValidation($model);

		if(isset($_POST['Hrsalaryset']))
		{
			$model->attributes=$_POST['Hrsalaryset'];
                        $status = 'Failure';
                        if ($model->save()) {
                            $status = 'Success';
                        }
	...
	{
		$dataProvider=new CActiveDataProvider('Hrsalaryset');
	...
	{
		$model=new Hrsalaryset('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Hrsalaryset']))
			$model->attributes=$_GET['Hrsalaryset'];
	...
	{
		$model=Hrsalaryset::model()->findByPk((int)$id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='hrsalaryset-form')
		{
        ...
        public function actionJsonmessage() {
            ...
            if(isset ($_REQUEST['cid'])){
                $model=Hrsalaryset::model()->findByPk($_REQUEST['cid']);
                if($model){
                    $jsonmessage['message'] = $model->idccfyear ;
                }
            }

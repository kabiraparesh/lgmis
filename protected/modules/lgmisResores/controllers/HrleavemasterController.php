...
class HrleavemasterController extends Controller
{
	/**
...
//        public $layout = '//layouts/eastsouthwest';
	...
	{
		$model=new Hrleavemaster;

		// Uncomment the following line if AJAX validation is needed
		$this->performAjaxValidation($model);

		if(isset($_POST['Hrleavemaster']))
		{
			$model->attributes=$_POST['Hrleavemaster'];
                        $status = 'Failure';
                        if ($model->save()) {
                            $status = 'Success';
                        }
	...
	{
		$dataProvider=new CActiveDataProvider('Hrleavemaster');
	...
	{
		$model=new Hrleavemaster('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Hrleavemaster']))
			$model->attributes=$_GET['Hrleavemaster'];
	...
	{
		$model=Hrleavemaster::model()->findByPk((int)$id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='hrleavemaster-form')
		{
        ...
        public function actionJsonmessage() {
            ...
            if(isset ($_REQUEST['cid'])){
                $model=Hrleavemaster::model()->findByPk($_REQUEST['cid']);
                if($model){

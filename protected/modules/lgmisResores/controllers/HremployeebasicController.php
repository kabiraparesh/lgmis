...
class HremployeebasicController extends Controller
{
	/**
...
//        public $layout = '//layouts/eastsouthwest';
	...
	{
		$model=new Hremployeebasic;

		// Uncomment the following line if AJAX validation is needed
		$this->performAjaxValidation($model);

		if(isset($_POST['Hremployeebasic']))
		{
			$model->attributes=$_POST['Hremployeebasic'];
                        $status = 'Failure';
                        if ($model->save()) {
                            $status = 'Success';
                        }
	...
	{
		$dataProvider=new CActiveDataProvider('Hremployeebasic');
	...
	{
		$model=new Hremployeebasic('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Hremployeebasic']))
			$model->attributes=$_GET['Hremployeebasic'];
	...
	{
		$model=Hremployeebasic::model()->findByPk((int)$id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='hremployeebasic-form')
		{
        ...
        public function actionJsonmessage() {
            ...
            if(isset ($_REQUEST['cid'])){
                $model=Hremployeebasic::model()->findByPk($_REQUEST['cid']);
                if($model){
                    $jsonmessage['message'] = $model->idhremployee ;
                }
            }

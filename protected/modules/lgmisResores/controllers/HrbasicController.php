...
class HrbasicController extends Controller
{
	/**
...
//        public $layout = '//layouts/eastsouthwest';
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Hrbasic']))
		{
			$model->attributes=$_POST['Hrbasic'];
                        $status = 'Failure';
                        if ($model->save()) {
                            $status = 'Success';
                        }
	...
	{
		$dataProvider=new CActiveDataProvider('Hrbasic');
	...
	{
		$model=new Hrbasic('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Hrbasic']))
			$model->attributes=$_GET['Hrbasic'];
	...
	{
		$model=Hrbasic::model()->findByPk((int)$id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='hrbasic-form')
		{
        ...
        public function actionJsonmessage() {
            ...
            if(isset ($_REQUEST['cid'])){
                $model=Hrbasic::model()->findByPk($_REQUEST['cid']);
                if($model){
                    $jsonmessage['message'] = $model->start ;
                }
            }

...
//        public $layout = '//layouts/eastsouthwest';
	...
	{
		$model=Hremployee::model()->findByPk((int)$id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='hremployee-form')
		{
        ...
        public function actionJsonmessage() {
            ...
            if(isset ($_REQUEST['cid'])){
                $model=Hremployee::model()->findByPk($_REQUEST['cid']);
                if($model){
                    $jsonmessage['message'] = $model->empname ;
                }
            }

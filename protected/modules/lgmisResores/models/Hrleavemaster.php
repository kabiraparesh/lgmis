...
class Hrleavemaster extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('idhremployee', 'required'),
			array('idhremployee, foryear, formonth, workingdays, attendence, casualleave, medicalleave, paidleave, otherleave, idccfyear, earnedleave', 'length', 'max'=>10),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('idhrleavemaster, idhremployee, foryear, formonth, workingdays, attendence, casualleave, medicalleave, paidleave, otherleave, idccfyear, earnedleave', 'safe', 'on'=>'search'),

...
class Lptype extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('lptype', 'required'),
			array('lptype', 'length', 'max'=>100),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('idlptype, lptype', 'safe', 'on'=>'search'),
		);
	}        
	...
	public function relations()
	{
		...
		return array(
			'lpapplicants' => array(self::HAS_MANY, 'Lpapplicant', 'idlptype'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'lptype' => Yii::t('application', 'Lptype'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('lptype',$this->lptype,true);

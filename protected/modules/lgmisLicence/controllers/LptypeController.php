...
//        public $layout = '//layouts/eastsouthwest';
	...
	{
		$model=Lptype::model()->findByPk((int)$id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='lptype-form')
		{
        ...
        public function actionJsonmessage() {
            ...
            if(isset ($_REQUEST['cid'])){
                $model=Lptype::model()->findByPk($_REQUEST['cid']);
                if($model){
                    $jsonmessage['message'] = $model->lptype ;
                }
            }

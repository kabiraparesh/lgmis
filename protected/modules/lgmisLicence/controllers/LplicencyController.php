...
class LplicencyController extends Controller
{
	/**
...
//        public $layout = '//layouts/eastsouthwest';
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Lplicency']))
		{
			$model->attributes=$_POST['Lplicency'];
                        $status = 'Failure';
                        if ($model->save()) {
                            $status = 'Success';
                        }
	...
	{
		$dataProvider=new CActiveDataProvider('Lplicency');
	...
	{
		$model=new Lplicency('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Lplicency']))
			$model->attributes=$_GET['Lplicency'];
	...
	{
		$model=Lplicency::model()->findByPk((int)$id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='lplicency-form')
		{
        ...
        public function actionJsonmessage() {
            ...
            if(isset ($_REQUEST['cid'])){
                $model=Lplicency::model()->findByPk($_REQUEST['cid']);
                if($model){
                    $jsonmessage['message'] = $model->licencyname ;
                }
            }

...
class LprelativeController extends Controller
{
	/**
...
//        public $layout = '//layouts/eastsouthwest';
	...
	{
		$model=new Lprelative;

		// Uncomment the following line if AJAX validation is needed
		$this->performAjaxValidation($model);

		if(isset($_POST['Lprelative']))
		{
			$model->attributes=$_POST['Lprelative'];
                        $status = 'Failure';
                        if ($model->save()) {
                            $status = 'Success';
                        }
	...
	{
		$dataProvider=new CActiveDataProvider('Lprelative');
	...
	{
		$model=new Lprelative('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Lprelative']))
			$model->attributes=$_GET['Lprelative'];
	...
	{
		$model=Lprelative::model()->findByPk((int)$id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='lprelative-form')
		{
        ...
        public function actionJsonmessage() {
            ...
            if(isset ($_REQUEST['cid'])){
                $model=Lprelative::model()->findByPk($_REQUEST['cid']);
                if($model){
                    $jsonmessage['message'] = $model->relativename ;
                }
            }

...
class LpbtypeController extends Controller
{
	/**
...
//        public $layout = '//layouts/eastsouthwest';
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Lpbtype']))
		{
			$model->attributes=$_POST['Lpbtype'];
                        $status = 'Failure';
                        if ($model->save()) {
                            $status = 'Success';
                        }
	...
	{
		$dataProvider=new CActiveDataProvider('Lpbtype');
	...
	{
		$model=new Lpbtype('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Lpbtype']))
			$model->attributes=$_GET['Lpbtype'];
	...
	{
		$model=Lpbtype::model()->findByPk((int)$id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='lpbtype-form')
		{
        ...
        public function actionJsonmessage() {
            ...
            if(isset ($_REQUEST['cid'])){
                $model=Lpbtype::model()->findByPk($_REQUEST['cid']);
                if($model){
                    $jsonmessage['message'] = $model->btype ;
                }
            }

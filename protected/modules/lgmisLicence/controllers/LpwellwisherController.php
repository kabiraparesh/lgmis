...
class LpwellwisherController extends Controller
{
	/**
...
//        public $layout = '//layouts/eastsouthwest';
	...
	{
		$model=new Lpwellwisher;

		// Uncomment the following line if AJAX validation is needed
		$this->performAjaxValidation($model);

		if(isset($_POST['Lpwellwisher']))
		{
			$model->attributes=$_POST['Lpwellwisher'];
                        $status = 'Failure';
                        if ($model->save()) {
                            $status = 'Success';
                        }
	...
	{
		$dataProvider=new CActiveDataProvider('Lpwellwisher');
	...
	{
		$model=new Lpwellwisher('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Lpwellwisher']))
			$model->attributes=$_GET['Lpwellwisher'];
	...
	{
		$model=Lpwellwisher::model()->findByPk((int)$id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='lpwellwisher-form')
		{
        ...
        public function actionJsonmessage() {
            ...
            if(isset ($_REQUEST['cid'])){
                $model=Lpwellwisher::model()->findByPk($_REQUEST['cid']);
                if($model){
                    $jsonmessage['message'] = $model->wishername ;
                }
            }

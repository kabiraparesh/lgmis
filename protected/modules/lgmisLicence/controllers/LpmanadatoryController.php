...
class LpmanadatoryController extends Controller
{
	/**
...
//        public $layout = '//layouts/eastsouthwest';
	...
	{
		$model=new Lpmanadatory;

		// Uncomment the following line if AJAX validation is needed
		$this->performAjaxValidation($model);

		if(isset($_POST['Lpmanadatory']))
		{
			$model->attributes=$_POST['Lpmanadatory'];
                        $status = 'Failure';
                        if ($model->save()) {
                            $status = 'Success';
                        }
	...
	{
		$dataProvider=new CActiveDataProvider('Lpmanadatory');
	...
	{
		$model=new Lpmanadatory('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Lpmanadatory']))
			$model->attributes=$_GET['Lpmanadatory'];
	...
	{
		$model=Lpmanadatory::model()->findByPk((int)$id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='lpmanadatory-form')
		{
        ...
        public function actionJsonmessage() {
            ...
            if(isset ($_REQUEST['cid'])){
                $model=Lpmanadatory::model()->findByPk($_REQUEST['cid']);
                if($model){
                    $jsonmessage['message'] = $model->lname ;
                }
            }

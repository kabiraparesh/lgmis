...
class LpgroupController extends Controller
{
	/**
...
//        public $layout = '//layouts/eastsouthwest';
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Lpgroup']))
		{
			$model->attributes=$_POST['Lpgroup'];
                        $status = 'Failure';
                        if ($model->save()) {
                            $status = 'Success';
                        }
	...
	{
		$dataProvider=new CActiveDataProvider('Lpgroup');
	...
	{
		$model=new Lpgroup('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Lpgroup']))
			$model->attributes=$_GET['Lpgroup'];
	...
	{
		$model=Lpgroup::model()->findByPk((int)$id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='lpgroup-form')
		{
        ...
        public function actionJsonmessage() {
            ...
            if(isset ($_REQUEST['cid'])){
                $model=Lpgroup::model()->findByPk($_REQUEST['cid']);
                if($model){
                    $jsonmessage['message'] = $model->lpgroup ;
                }
            }

...
class LpapplicantController extends Controller
{
	/**
...
//        public $layout = '//layouts/eastsouthwest';
	...
	{
		$model=new Lpapplicant;

		// Uncomment the following line if AJAX validation is needed
		$this->performAjaxValidation($model);

		if(isset($_POST['Lpapplicant']))
		{
			$model->attributes=$_POST['Lpapplicant'];
                        $status = 'Failure';
                        if ($model->save()) {
                            $status = 'Success';
                        }
	...
	{
		$dataProvider=new CActiveDataProvider('Lpapplicant');
	...
	{
		$model=new Lpapplicant('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Lpapplicant']))
			$model->attributes=$_GET['Lpapplicant'];
	...
	{
		$model=Lpapplicant::model()->findByPk((int)$id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='lpapplicant-form')
		{
        ...
        public function actionJsonmessage() {
            ...
            if(isset ($_REQUEST['cid'])){
                $model=Lpapplicant::model()->findByPk($_REQUEST['cid']);
                if($model){
                    $jsonmessage['message'] = $model->bussname ;
                }
            }

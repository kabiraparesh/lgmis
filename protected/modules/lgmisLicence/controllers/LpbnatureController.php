...
class LpbnatureController extends Controller
{
	/**
...
//        public $layout = '//layouts/eastsouthwest';
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Lpbnature']))
		{
			$model->attributes=$_POST['Lpbnature'];
                        $status = 'Failure';
                        if ($model->save()) {
                            $status = 'Success';
                        }
	...
	{
		$dataProvider=new CActiveDataProvider('Lpbnature');
	...
	{
		$model=new Lpbnature('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Lpbnature']))
			$model->attributes=$_GET['Lpbnature'];
	...
	{
		$model=Lpbnature::model()->findByPk((int)$id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='lpbnature-form')
		{
        ...
        public function actionJsonmessage() {
            ...
            if(isset ($_REQUEST['cid'])){
                $model=Lpbnature::model()->findByPk($_REQUEST['cid']);
                if($model){
                    $jsonmessage['message'] = $model->lpnature ;
                }
            }

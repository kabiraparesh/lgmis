...
class BddeathrateController extends Controller
{
	/**
...
//        public $layout = '//layouts/eastsouthwest';
	...
	{
		$model=new Bddeathrate;

		// Uncomment the following line if AJAX validation is needed
		$this->performAjaxValidation($model);

		if(isset($_POST['Bddeathrate']))
		{
			$model->attributes=$_POST['Bddeathrate'];
                        $status = 'Failure';
                        if ($model->save()) {
                            $status = 'Success';
                        }
	...
	{
		$dataProvider=new CActiveDataProvider('Bddeathrate');
	...
	{
		$model=new Bddeathrate('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Bddeathrate']))
			$model->attributes=$_GET['Bddeathrate'];
	...
	{
		$model=Bddeathrate::model()->findByPk((int)$id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='bddeathrate-form')
		{
        ...
        public function actionJsonmessage() {
            ...
            if(isset ($_REQUEST['cid'])){
                $model=Bddeathrate::model()->findByPk($_REQUEST['cid']);
                if($model){
                    $jsonmessage['message'] = $model->deathperiod ;
                }
            }

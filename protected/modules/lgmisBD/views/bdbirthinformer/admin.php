...
$pagertoolbox .= CHtml::link("<div class='ui-pg-div'><span class='ui-icon ui-icon-trash'></span></div>", '#', array(
            ...
            'onclick'=>'
                    if($.fn.yiiGridView.getSelection("bdbirthinformer-grid") != ""){
                        ...
                        window.url = "'. CController::createUrl('lgmisBD/bdbirthinformer/delete').'";
...
$pagertoolbox .= CHtml::link(
                ...
                $htmlOptions = array(
                    ...
                    'onclick' => '
                        if($.fn.yiiGridView.getSelection("bdbirthinformer-grid") != ""){
                      // window.location.href="'.Yii::app()->createUrl('lgmisBD/bdbirthapplication/admin').'&idparent=" + $.fn.yiiGridView.getSelection("bdbirthinformer-grid");
                            $.ajax({
                              url: "'.Yii::app()->createUrl('lgmisBD/bdbirthapplication/create').'&isAjaxRequest=1&idparent=" + $.fn.yiiGridView.getSelection("bdbirthinformer-grid"),
                                  success: function(data){
                                     $("#dialog").html(data);

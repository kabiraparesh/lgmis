...
$this->breadcrumbs=array(
	...
	Yii::t('application',$model->idbdbirthrate)=>array('view','id'=>$model->idbdbirthrate),
...
//	array('label'=>Yii::t('application', 'List {title}', array('{title}'=>Yii::t('application', 'Bdbirthrate'))), 'url'=>array('index')),
	array('label'=>Yii::t('application','Create {title}', array('{title}'=>Yii::t('application', 'Bdbirthrate'))), 'url'=>array('create')),
        array('label'=>Yii::t('application', 'View {title}', array('{title}'=>Yii::t('application', 'Bdbirthrate'))), 'url'=>array('view', 'id'=>$model->idbdbirthrate)),
	array('label'=>Yii::t('application','Manage {title}', array('{title}'=>Yii::t('application', 'Bdbirthrate'))), 'url'=>array('admin')),
);
?>

<h1><?php echo Yii::t('application','Update {title}', array('{title}'=>Yii::t('application', 'Bdbirthrate'))) ;?> <?php echo $model->idbdbirthrate; ?> </h1>

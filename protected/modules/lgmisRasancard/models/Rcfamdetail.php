 ...
 * @property Rcapplication $idrcapplication0
 */
class Rcfamdetail extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('name, voterno, hfname, headoffamily, idrcapplication', 'required'),
			array('name, voterno, hfname, headoffamily', 'length', 'max'=>100),
			array('age, idccrelation, idrcapplication', 'length', 'max'=>10),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('idrcfamdetail, name, age, idccrelation, voterno, hfname, headoffamily, idrcapplication', 'safe', 'on'=>'search'),
                        array('idccrelation, idrcapplication', 'validatefkeys'),
		);
	}        
	...
	public function relations()
	{
		...
		return array(
			...
			'idrcapplication0' => array(self::BELONGS_TO, 'Rcapplication', 'idrcapplication'),
		);
	}

...
class RcfamdetailController extends Controller
{
	/**
...
//        public $layout = '//layouts/eastsouthwest';
	...
	{
		$model=new Rcfamdetail;

		// Uncomment the following line if AJAX validation is needed
		$this->performAjaxValidation($model);

		if(isset($_POST['Rcfamdetail']))
		{
			$model->attributes=$_POST['Rcfamdetail'];
                        $status = 'Failure';
                        if ($model->save()) {
                            $status = 'Success';
                        }
	...
	{
		$dataProvider=new CActiveDataProvider('Rcfamdetail');
	...
	{
		$model=new Rcfamdetail('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Rcfamdetail']))
			$model->attributes=$_GET['Rcfamdetail'];
	...
	{
		$model=Rcfamdetail::model()->findByPk((int)$id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='rcfamdetail-form')
		{
        ...
        public function actionJsonmessage() {
            ...
            if(isset ($_REQUEST['cid'])){
                $model=Rcfamdetail::model()->findByPk($_REQUEST['cid']);
                if($model){
                    $jsonmessage['message'] = $model->name ;
                }
            }

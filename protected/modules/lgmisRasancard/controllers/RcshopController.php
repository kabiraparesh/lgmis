...
class RcshopController extends Controller
{
	/**
...
//        public $layout = '//layouts/eastsouthwest';
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Rcshop']))
		{
			$model->attributes=$_POST['Rcshop'];
                        $status = 'Failure';
                        if ($model->save()) {
                            $status = 'Success';
                        }
	...
	{
		$dataProvider=new CActiveDataProvider('Rcshop');
	...
	{
		$model=new Rcshop('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Rcshop']))
			$model->attributes=$_GET['Rcshop'];
	...
	{
		$model=Rcshop::model()->findByPk((int)$id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='rcshop-form')
		{
        ...
        public function actionJsonmessage() {
            ...
            if(isset ($_REQUEST['cid'])){
                $model=Rcshop::model()->findByPk($_REQUEST['cid']);
                if($model){
                    $jsonmessage['message'] = $model->sname ;
                }
            }

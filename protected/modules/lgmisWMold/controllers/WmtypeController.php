...
class WmtypeController extends Controller
{
	/**
	...
	{
		$dataProvider=new CActiveDataProvider('Wmtype');
	...
	{
		$model=new Wmtype('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Wmtype']))
			$model->attributes=$_GET['Wmtype'];
	...
	{
		$model=Wmtype::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='wmtype-form')
		{

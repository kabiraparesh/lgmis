...
class WmplumberController extends Controller
{
	/**
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Wmplumber']))
		{
			$model->attributes=$_POST['Wmplumber'];
	...
	{
		$dataProvider=new CActiveDataProvider('Wmplumber');
	...
	{
		$model=new Wmplumber('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Wmplumber']))
			$model->attributes=$_GET['Wmplumber'];
	...
	{
		$model=Wmplumber::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='wmplumber-form')
		{

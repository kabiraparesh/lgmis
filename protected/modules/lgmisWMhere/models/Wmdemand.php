...
class Wmdemand extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('idwmmaster', 'required'),
			array('idwmmaster, idccfyear, period, wmoldbalance, wmsurcharge, wmdemandamt', 'length', 'max'=>10),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('idwmdemand, idwmmaster, idccfyear, period, wmoldbalance, wmsurcharge, wmdemandamt, wmdemanddate', 'safe', 'on'=>'search'),
                        array('idwmmaster, idccfyear', 'validatefkeys'),
		);
	}        

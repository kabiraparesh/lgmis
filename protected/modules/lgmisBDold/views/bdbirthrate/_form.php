	...
	<div class="row">
		<?php echo $form->labelEx($model,'idccfyear'); ?>		
                ...
                <?php
                    ...
                    echo CHtml::ajaxLink(
                            $imghtml, 
                           // array( CHtml::ajaxLink(Yii::app()->request->getUrl(),array('type' =>'GET','data' =>array('ccfyear/popupview') ))), // the URL for the AJAX request. If empty, it is assumed to be the current URL.

...
$pagertoolbox .= "<td>";
$pagertoolbox .= CHtml::link(
                "<div class='ui-pg-div'><span style='font-size: smaller'>&nbsp;&nbsp;&nbsp;&nbsp;" . Yii::t('application', 'Birthapplication') . "</span>", 
                "#",
                $htmlOptions = array(
...
if (!isset($_REQUEST['report'])) {
    ...
    $pagertoolbox .= CHtml::link(
                    " <span style='font-size: smaller'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" . Yii::t('application', 'fddemandreceipt') . "</span>", "#", $htmlOptions = array(
                'title' => Yii::t('application', 'View'),
                'onclick' => '
                            if($.fn.yiiGridView.getSelection("bdbirthinformer-grid") != ""){
                                $.ajax({
                                url: "' . Yii::app()->createUrl('fddemandreceipt/create') . '&isAjaxRequest=1&id=" + $.fn.yiiGridView.getSelection("bdbirthinformer-grid"),
                                success: function(data){
                                    $("#dialog").html(data);
...
if (isset($_REQUEST['report']) && $_REQUEST['report'] == 'viewBill') {
    ...
    $pagertoolbox .= CHtml::link(
                    ...
                    $htmlOptions = array(
                        ...
                        'onclick' => '
                            window.open("'.Yii::app()->createUrl('report/viewBill').'&isAjaxRequest=1&id=" + $.fn.yiiGridView.getSelection("bdbirthinformer-grid"));
                            ',
                    'sytle' => ''
                    )
    );

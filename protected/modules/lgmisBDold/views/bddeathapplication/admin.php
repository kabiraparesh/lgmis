...
$this->setPageTitle(Yii::t('application', 'Bddeathapplication'));
?>
<?php
$this->menu=array(
...
$('.bddeathapplication-search-button').click(function(){
	$('.bddeathapplication-search-form').toggle();
	return false;
});
$('.bddeathapplication-search-form form').submit(function(){
...
<?php //echo CHtml::link(Yii::t('application', 'Advanced Search'),'#',array('class'=>'bddeathapplication-search-button')); ?>
<div class="bddeathapplication-search-form" style="display:none">
...
$pagertoolbox .= CHtml::link(
        ...
        $htmlOptions = array(
            ...
            'onclick' => '$.fn.yiiGridView.update("bddeathapplication-grid", {
		data: $(this).serialize()
            });'
            ));
$pagertoolbox .= "</td>";
...
$pagertoolbox .= CHtml::link(
                ...
                $htmlOptions = array(
                    ...
                    'onclick' => '
                        $.ajax({
                          url: "'.Yii::app()->createUrl('lgmisBD/bddeathapplication/create').'&isAjaxRequest=1",
                ...
                $htmlOptions = array(
                    'onclick' => '
                          if($.fn.yiiGridView.getSelection("bddeathapplication-grid") != ""){
                                $.ajax({
                                  url: "'.Yii::app()->createUrl('lgmisBD/bddeathapplication/update').'&isAjaxRequest=1&id=" + $.fn.yiiGridView.getSelection("bddeathapplication-grid"),
                                  success: function(data){
                                     $("#dialog").html(data);
                                     $("#dialog").dialog("option", "title", "'. Yii::t('application','Update {title}', array('{title}'=>Yii::t('application', 'bddeathapplication'))) .' - " + $.fn.yiiGridView.getSelection("bddeathapplication-grid"));
                                     $("#dialog").dialog("option", "height", "auto");
                                     $("#dialog").dialog("option", "width", "auto");
                                     $("#dialog").dialog("open"); 
                                     return false;
...
$pagertoolbox .= CHtml::link("<div class='ui-pg-div'><span class='ui-icon ui-icon-trash'></span></div>", '#', array(
            ...
            'onclick'=>'
                    if($.fn.yiiGridView.getSelection("bddeathapplication-grid") != ""){
                        ...
                        window.url = "'. CController::createUrl('bddeathapplication/delete').'";
...
$pagertoolbox .= CHtml::link(
                ...
                $htmlOptions = array(
                    'onclick' => '
                        if($.fn.yiiGridView.getSelection("bddeathapplication-grid") != ""){
                            $.ajax({
                              url: "'.Yii::app()->createUrl('lgmisBD/bddeathapplication/view').'&isAjaxRequest=1&id=" + $.fn.yiiGridView.getSelection("bddeathapplication-grid"),
                              success: function(data){
                                $("#dialog").html(data);
                                $("#dialog").dialog("option", "title", "'. Yii::t('application','View {title}', array('{title}'=>Yii::t('application', 'bddeathapplication'))) .' - " + $.fn.yiiGridView.getSelection("bddeathapplication-grid"));
                                $("#dialog").dialog("option", "height", "auto");
                                $("#dialog").dialog("option", "width", "auto");
                                $("#dialog").dialog("open"); 
                                return false;

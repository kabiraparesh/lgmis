...
class BdbirthinformerController extends Controller
{
	/**
...
//        public $layout = '//layouts/eastsouthwest';
	...
	{
		$model=new Bdbirthinformer;

		// Uncomment the following line if AJAX validation is needed
		$this->performAjaxValidation($model);

		if(isset($_POST['Bdbirthinformer']))
		{
			$model->attributes=$_POST['Bdbirthinformer'];
                        $status = 'Failure';
                        if ($model->save()) {
                            $status = 'Success';
                        }
	...
	{
		$dataProvider=new CActiveDataProvider('Bdbirthinformer');
	...
	{
		$model=new Bdbirthinformer('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Bdbirthinformer']))
			$model->attributes=$_GET['Bdbirthinformer'];
	...
	{
		$model=Bdbirthinformer::model()->findByPk((int)$id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='bdbirthinformer-form')
		{
        ...
        public function actionJsonmessage() {
            ...
            if(isset ($_REQUEST['cid'])){
                $model=Bdbirthinformer::model()->findByPk($_REQUEST['cid']);
                if($model){
                    $jsonmessage['message'] = $model->informername ;
                }
            }

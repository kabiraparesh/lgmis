...
class BdbirthrateController extends Controller
{
	/**
...
//        public $layout = '//layouts/eastsouthwest';
	...
	public function accessRules()
	{
		return array(
			array('allow',  // allow all users to perform 'index' and 'view' actions
				'actions'=>array('index','view', 'jsonmessage','delete'),
				'users'=>array('*'),
			),
	...
	{
		$model=new Bdbirthrate;

		// Uncomment the following line if AJAX validation is needed
		$this->performAjaxValidation($model);

		if(isset($_POST['Bdbirthrate']))
		{
			$model->attributes=$_POST['Bdbirthrate'];
                        $status = 'Failure';
                        if ($model->save()) {
                            $status = 'Success';
                        }
	...
	{
		$dataProvider=new CActiveDataProvider('Bdbirthrate');
	...
	{
		$model=new Bdbirthrate('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Bdbirthrate']))
			$model->attributes=$_GET['Bdbirthrate'];
	...
	{
		$model=Bdbirthrate::model()->findByPk((int)$id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='bdbirthrate-form')
		{
        ...
        public function actionJsonmessage() {
            ...
            if(isset ($_REQUEST['cid'])){
                $model=Bdbirthrate::model()->findByPk($_REQUEST['cid']);
                if($model){
                    $jsonmessage['message'] = $model->bdbirthperiod ;
                }
            }

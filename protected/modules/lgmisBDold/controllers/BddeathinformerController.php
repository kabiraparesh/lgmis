...
class BddeathinformerController extends Controller
{
	/**
...
//        public $layout = '//layouts/eastsouthwest';
	...
	{
		$model=new Bddeathinformer;

		// Uncomment the following line if AJAX validation is needed
		$this->performAjaxValidation($model);

		if(isset($_POST['Bddeathinformer']))
		{
			$model->attributes=$_POST['Bddeathinformer'];
                        $status = 'Failure';
                        if ($model->save()) {
                            $status = 'Success';
                        }
	...
	{
		$dataProvider=new CActiveDataProvider('Bddeathinformer');
	...
	{
		$model=new Bddeathinformer('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Bddeathinformer']))
			$model->attributes=$_GET['Bddeathinformer'];
	...
	{
		$model=Bddeathinformer::model()->findByPk((int)$id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='bddeathinformer-form')
		{
        ...
        public function actionJsonmessage() {
            ...
            if(isset ($_REQUEST['cid'])){
                $model=Bddeathinformer::model()->findByPk($_REQUEST['cid']);
                if($model){

...
class CmapplicationController extends Controller
{
	/**
...
//        public $layout = '//layouts/eastsouthwest';
	...
	{
		$model=new Cmapplication;

		// Uncomment the following line if AJAX validation is needed
		$this->performAjaxValidation($model);

		if(isset($_POST['Cmapplication']))
		{
			$model->attributes=$_POST['Cmapplication'];
                        $status = 'Failure';
                        if ($model->save()) {
                            $status = 'Success';
                        }
	...
	{
		$dataProvider=new CActiveDataProvider('Cmapplication');
	...
	{
		$model=new Cmapplication('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Cmapplication']))
			$model->attributes=$_GET['Cmapplication'];
	...
	{
		$model=Cmapplication::model()->findByPk((int)$id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='cmapplication-form')
		{
        ...
        public function actionJsonmessage() {
            ...
            if(isset ($_REQUEST['cid'])){
                $model=Cmapplication::model()->findByPk($_REQUEST['cid']);
                if($model){
                    $jsonmessage['message'] = $model->idcmsource ;
                }
            }

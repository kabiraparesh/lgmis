...
//        public $layout = '//layouts/eastsouthwest';
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Cmgroup']))
		{
			$model->attributes=$_POST['Cmgroup'];
                        $status = 'Failure';
                        if ($model->save()) {
                            $status = 'Success';
                        }
	...
	{
		$dataProvider=new CActiveDataProvider('Cmgroup');
	...
	{
		$model=new Cmgroup('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Cmgroup']))
			$model->attributes=$_GET['Cmgroup'];
	...
	{
		$model=Cmgroup::model()->findByPk((int)$id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='cmgroup-form')
		{
        ...
        public function actionJsonmessage() {
            ...
            if(isset ($_REQUEST['cid'])){
                $model=Cmgroup::model()->findByPk($_REQUEST['cid']);
                if($model){
                    $jsonmessage['message'] = $model->groupname ;
                }
            }

...
class CmcomplaintController extends Controller
{
	/**
...
//        public $layout = '//layouts/eastsouthwest';
	...
	{
		$model=new Cmcomplaint;

		// Uncomment the following line if AJAX validation is needed
		$this->performAjaxValidation($model);

		if(isset($_POST['Cmcomplaint']))
		{
			$model->attributes=$_POST['Cmcomplaint'];
                        $status = 'Failure';
                        if ($model->save()) {
                            $status = 'Success';
                        }
	...
	{
		$dataProvider=new CActiveDataProvider('Cmcomplaint');
	...
	{
		$model=new Cmcomplaint('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Cmcomplaint']))
			$model->attributes=$_GET['Cmcomplaint'];
	...
	{
		$model=Cmcomplaint::model()->findByPk((int)$id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='cmcomplaint-form')
		{
        ...
        public function actionJsonmessage() {
            ...
            if(isset ($_REQUEST['cid'])){
                $model=Cmcomplaint::model()->findByPk($_REQUEST['cid']);
                if($model){
                    $jsonmessage['message'] = $model->complaintname ;
                }
            }

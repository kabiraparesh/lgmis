...
class CmcategoriesController extends Controller
{
	/**
...
//        public $layout = '//layouts/eastsouthwest';
	...
	{
		$model=new Cmcategories;

		// Uncomment the following line if AJAX validation is needed
		$this->performAjaxValidation($model);

		if(isset($_POST['Cmcategories']))
		{
			$model->attributes=$_POST['Cmcategories'];
                        $status = 'Failure';
                        if ($model->save()) {
                            $status = 'Success';
                        }
	...
	{
		$dataProvider=new CActiveDataProvider('Cmcategories');
	...
	{
		$model=new Cmcategories('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Cmcategories']))
			$model->attributes=$_GET['Cmcategories'];
	...
	{
		$model=Cmcategories::model()->findByPk((int)$id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='cmcategories-form')
		{
        ...
        public function actionJsonmessage() {
            ...
            if(isset ($_REQUEST['cid'])){
                $model=Cmcategories::model()->findByPk($_REQUEST['cid']);
                if($model){
                    $jsonmessage['message'] = $model->categoriesname ;
                }
            }

...
//        public $layout = '//layouts/eastsouthwest';
	...
	{
		$model=new Bpapplication;

		// Uncomment the following line if AJAX validation is needed
		$this->performAjaxValidation($model);

		if(isset($_POST['Bpapplication']))
		{
			$model->attributes=$_POST['Bpapplication'];
                        $status = 'Failure';
                        if ($model->save()) {
                            $status = 'Success';
                        }
	...
	{
		$dataProvider=new CActiveDataProvider('Bpapplication');
	...
	{
		$model=new Bpapplication('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Bpapplication']))
			$model->attributes=$_GET['Bpapplication'];
	...
	{
		$model=Bpapplication::model()->findByPk((int)$id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='bpapplication-form')
		{
        ...
        public function actionJsonmessage() {
            ...
            if(isset ($_REQUEST['cid'])){
                $model=Bpapplication::model()->findByPk($_REQUEST['cid']);
                if($model){
                    $jsonmessage['message'] = $model->applicantname ;
                }
            }

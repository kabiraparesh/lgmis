...
class BparearateController extends Controller
{
	/**
...
//        public $layout = '//layouts/eastsouthwest';
	...
	{
		$model=new Bparearate;

		// Uncomment the following line if AJAX validation is needed
		$this->performAjaxValidation($model);

		if(isset($_POST['Bparearate']))
		{
			$model->attributes=$_POST['Bparearate'];
                        $status = 'Failure';
                        if ($model->save()) {
                            $status = 'Success';
                        }
	...
	{
		$dataProvider=new CActiveDataProvider('Bparearate');
	...
	{
		$model=new Bparearate('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Bparearate']))
			$model->attributes=$_GET['Bparearate'];
	...
	{
		$model=Bparearate::model()->findByPk((int)$id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='bparearate-form')
		{
        ...
        public function actionJsonmessage() {
            ...
            if(isset ($_REQUEST['cid'])){
                $model=Bparearate::model()->findByPk($_REQUEST['cid']);
                if($model){

...
class BpusagetypeController extends Controller
{
	/**
...
//        public $layout = '//layouts/eastsouthwest';
	...
	{
		$model=new Bpusagetype;

		// Uncomment the following line if AJAX validation is needed
		$this->performAjaxValidation($model);

		if(isset($_POST['Bpusagetype']))
		{
			$model->attributes=$_POST['Bpusagetype'];
                        $status = 'Failure';
                        if ($model->save()) {
                            $status = 'Success';
                        }
	...
	{
		$dataProvider=new CActiveDataProvider('Bpusagetype');
	...
	{
		$model=new Bpusagetype('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Bpusagetype']))
			$model->attributes=$_GET['Bpusagetype'];
	...
	{
		$model=Bpusagetype::model()->findByPk((int)$id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='bpusagetype-form')
		{
        ...
        public function actionJsonmessage() {
            ...
            if(isset ($_REQUEST['cid'])){
                $model=Bpusagetype::model()->findByPk($_REQUEST['cid']);
                if($model){
                    $jsonmessage['message'] = $model->usagetype ;
                }
            }

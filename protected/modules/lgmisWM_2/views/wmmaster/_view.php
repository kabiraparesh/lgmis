...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('saralno')); ?>:</b>
	<?php echo CHtml::encode($data->saralno); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('connectionno')); ?>:</b>
	<?php echo CHtml::encode($data->connectionno); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('disconnectdate')); ?>:</b>
	<?php echo CHtml::encode($data->disconnectdate); ?>
	<br />

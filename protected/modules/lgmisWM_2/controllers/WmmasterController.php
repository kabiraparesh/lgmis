	...
	public function accessRules()
	{
		return array(
			array('allow',  // allow all users to perform 'index' and 'view' actions
				'actions'=>array('index','view', 'dynamiccccolony'),
				'users'=>array('*'),
			),
        ...
        public function actionDynamiccccolony(){
            
                $data = Cccolony::model()->findAll('idccward=:parent_id', array(':parent_id'=>(int) $_POST['idccward']));

                $data=CHtml::listData($data,'idcccolony','colonyname');
                $i = 0;
                ...
                syslog(LOG_WARNING, 'actionDynamiccccolony: ' . $_POST['idccward'] . ' ' . $i);
        }
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Wmmaster']))
		{
			$model->attributes=$_POST['Wmmaster'];
                    ...
                    $model->idwmplumber = 1;
                    $model->idccstatus = 1;
                    $model->wmmasterflag = 1;
                    $model->idwmexsumptor = 3;
                    Yii::app()->clientscript->scriptMap['jquery.js'] = false;
...
//                    $model->idccward = $model->idcccolony0->idccward;

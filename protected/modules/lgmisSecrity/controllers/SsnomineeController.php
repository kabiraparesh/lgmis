...
class SsnomineeController extends Controller
{
	/**
...
//        public $layout = '//layouts/eastsouthwest';
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Ssnominee']))
		{
			$model->attributes=$_POST['Ssnominee'];
                        $status = 'Failure';
                        if ($model->save()) {
                            $status = 'Success';
                        }
	...
	{
		$dataProvider=new CActiveDataProvider('Ssnominee');
	...
	{
		$model=new Ssnominee('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Ssnominee']))
			$model->attributes=$_GET['Ssnominee'];
	...
	{
		$model=Ssnominee::model()->findByPk((int)$id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='ssnominee-form')
		{
        ...
        public function actionJsonmessage() {
            ...
            if(isset ($_REQUEST['cid'])){
                $model=Ssnominee::model()->findByPk($_REQUEST['cid']);
                if($model){

...
class SsschemeController extends Controller
{
	/**
...
//        public $layout = '//layouts/eastsouthwest';
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Ssscheme']))
		{
			$model->attributes=$_POST['Ssscheme'];
                        $status = 'Failure';
                        if ($model->save()) {
                            $status = 'Success';
                        }
	...
	{
		$dataProvider=new CActiveDataProvider('Ssscheme');
	...
	{
		$model=new Ssscheme('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Ssscheme']))
			$model->attributes=$_GET['Ssscheme'];
	...
	{
		$model=Ssscheme::model()->findByPk((int)$id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='ssscheme-form')
		{
        ...
        public function actionJsonmessage() {
            ...
            if(isset ($_REQUEST['cid'])){
                $model=Ssscheme::model()->findByPk($_REQUEST['cid']);
                if($model){

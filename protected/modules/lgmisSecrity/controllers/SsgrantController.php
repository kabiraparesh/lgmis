...
class SsgrantController extends Controller
{
	/**
...
//        public $layout = '//layouts/eastsouthwest';
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Ssgrant']))
		{
			$model->attributes=$_POST['Ssgrant'];
                        $status = 'Failure';
                        if ($model->save()) {
                            $status = 'Success';
                        }
	...
	{
		$dataProvider=new CActiveDataProvider('Ssgrant');
	...
	{
		$model=new Ssgrant('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Ssgrant']))
			$model->attributes=$_GET['Ssgrant'];
	...
	{
		$model=Ssgrant::model()->findByPk((int)$id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='ssgrant-form')
		{
        ...
        public function actionJsonmessage() {
            ...
            if(isset ($_REQUEST['cid'])){
                $model=Ssgrant::model()->findByPk($_REQUEST['cid']);
                if($model){

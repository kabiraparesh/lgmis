...
class SsapplicationController extends Controller
{
	/**
...
//        public $layout = '//layouts/eastsouthwest';
	...
	{
		$model=new Ssapplication;

		// Uncomment the following line if AJAX validation is needed
		$this->performAjaxValidation($model);

		if(isset($_POST['Ssapplication']))
		{
			$model->attributes=$_POST['Ssapplication'];
                        $status = 'Failure';
                        if ($model->save()) {
                            $status = 'Success';
                        }
	...
	{
		$dataProvider=new CActiveDataProvider('Ssapplication');
	...
	{
		$model=new Ssapplication('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Ssapplication']))
			$model->attributes=$_GET['Ssapplication'];
	...
	{
		$model=Ssapplication::model()->findByPk((int)$id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='ssapplication-form')
		{
        ...
        public function actionJsonmessage() {
            ...
            if(isset ($_REQUEST['cid'])){
                $model=Ssapplication::model()->findByPk($_REQUEST['cid']);
                if($model){
                    $jsonmessage['message'] = $model->type ;
                }
            }

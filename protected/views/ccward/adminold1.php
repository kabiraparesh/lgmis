    ...
    $(document).ready(function() {
        $('#reportlist').change(function() {
            ...
            switch(n){
                ...
                case '12':
                    if($.fn.yiiGridView.getSelection("ccward-grid") != ""){
                        window.open("<?php echo Yii::app()->createUrl('report/viewBills');?>&isAjaxRequest=1&type=1&id=" + $.fn.yiiGridView.getSelection("ccward-grid"));
                    }
                    else{
                        $("#dialog-warning-msg").html("<?php echo Yii::t('application', 'Please, select row...'); ?>"); $("#dialog-warning").dialog("open"); return false;
                    }
                ...
                case '13':
                    if($.fn.yiiGridView.getSelection("ccward-grid") != ""){
                        window.open("<?php echo Yii::app()->createUrl('report/report');?>&type=1&id=" + $.fn.yiiGridView.getSelection("ccward-grid") + '&report=1');
                    }
                    else{
                        $("#dialog-warning-msg").html("<?php echo Yii::t('application', 'Please, select row...'); ?>"); $("#dialog-warning").dialog("open"); return false;
                    }
                ...
                case '9':
                    if($.fn.yiiGridView.getSelection("ccward-grid") != ""){
                        window.open("<?php echo Yii::app()->createUrl('report/report');?>&id=" + $.fn.yiiGridView.getSelection("ccward-grid") + '&report=6');
                    }
                    else{
                        $("#dialog-warning-msg").html("<?php echo Yii::t('application', 'Please, select row...'); ?>"); $("#dialog-warning").dialog("open"); return false;
                    }
                	break;
                case '11':
                    window.open("<?php echo Yii::app()->createUrl('report/report5_2');?>");
                    break;
...
if(isset($_REQUEST['report']) && $_REQUEST['report'] == 'wardwisedemand'){
	...
	echo CHtml::dropDownList(
	        'reportlist', '', array('1' => Yii::t('application', 'Wardwise Demand'), '2' => Yii::t('application', 'Wardwise Demand'), '2' => Yii::t('application', 'Wardwise Demand Detailed'),  '3' => Yii::t('application', 'Bill Report'), '12' => Yii::t('application', 'Bill Report') . ' (2)', '4' => Yii::t('application', 'Propertytax Register'), '13' => Yii::t('application', 'Propertytax Register') . ' (2)', '5' => Yii::t('application', 'Only Minsamekittax'), '6' => Yii::t('application', 'Only Propertytax'), '8' => Yii::t('application', 'Wardwise Total Demand'), '11' => Yii::t('application', 'Wardwise Total Demand') . " (2)"), array('style' => 'font-size: 1em; margin: 2px; padding-right: 10px;padding-left: 10px;', 'empty' => Yii::t('application', '--Select a Report--'), 'id' => 'reportlist')
	//        'reportlist', '', array('1' => Yii::t('application', 'Wardwise Demand'), '2' => Yii::t('application', 'Wardwise Demand'), '2' => Yii::t('application', 'Wardwise Demand Detailed'),  '3' => Yii::t('application', 'Bill Report'), '4' => Yii::t('application', 'Propertytax Register'), '5' => Yii::t('application', 'Only Minsamekittax'), '6' => Yii::t('application', 'Only Propertytax'), '7' => Yii::t('application', 'Wardwise Property Count & Area'), '8' => Yii::t('application', 'Wardwise Total Demand'), '9' => Yii::t('application', 'Wardwise Recovery Report')), array('style' => 'font-size: 1em; margin: 2px; padding-right: 10px;padding-left: 10px;', 'empty' => Yii::t('application', '--Select a Report--'), 'id' => 'reportlist')
	    );

...
$this->setPageTitle(Yii::t('application', 'Cczone'));
?>
<?php
$this->menu=array(
...
$('.cczone-search-button').click(function(){
	$('.cczone-search-form').toggle();
	return false;
});
$('.cczone-search-form form').submit(function(){
...
<?php echo CHtml::link(Yii::t('application', 'Advanced Search'),'#',array('class'=>'cczone-search-button')); ?>
<div class="cczone-search-form" style="display:none">
...
$pagertoolbox .= CHtml::link(
        ...
        $htmlOptions = array(
            ...
            'onclick' => '$.fn.yiiGridView.update("cczone-grid", {
		data: $(this).serialize()
            });'
            ));
$pagertoolbox .= "</td>";
...
$pagertoolbox .= CHtml::link(
                ...
                $htmlOptions = array(
                    ...
                    'onclick' => '
                        $.ajax({
                          url: "'.Yii::app()->createUrl('cczone/create').'&isAjaxRequest=1",
                          success: function(data){
                             $("#dialog").html(data);
                             $("#dialog").dialog("option", "title", "'. Yii::t('application', 'Create {title}', array('{title}'=>Yii::t('application', 'cczone'))) .'");
...
$pagertoolbox .= CHtml::link(
                ...
                $htmlOptions = array(
                    'onclick' => '
                          if($.fn.yiiGridView.getSelection("cczone-grid") != ""){
                                $.ajax({
                                  url: "'.Yii::app()->createUrl('cczone/update').'&isAjaxRequest=1&id=" + $.fn.yiiGridView.getSelection("cczone-grid"),
                                  success: function(data){
                                     $("#dialog").html(data);
                                     $("#dialog").dialog("option", "title", "'. Yii::t('application','Update {title}', array('{title}'=>Yii::t('application', 'cczone'))) .' - " + $.fn.yiiGridView.getSelection("cczone-grid"));
                                     $("#dialog").dialog("option", "height", "auto");
                                     $("#dialog").dialog("option", "width", "auto");
                                     $("#dialog").dialog("open"); 
                                     return false;
...
$pagertoolbox .= CHtml::link("<div class='ui-pg-div'><span class='ui-icon ui-icon-trash'></span></div>", '#', array(
            ...
            'onclick'=>'
                    if($.fn.yiiGridView.getSelection("cczone-grid") != ""){
                        window.cid = "cczone";
                        window.url = "'. CController::createUrl('cczone/delete').'";
...
$pagertoolbox .= CHtml::link(
                ...
                $htmlOptions = array(
                    'onclick' => '
                        if($.fn.yiiGridView.getSelection("cczone-grid") != ""){
                            $.ajax({
                              url: "'.Yii::app()->createUrl('cczone/view').'&isAjaxRequest=1&id=" + $.fn.yiiGridView.getSelection("cczone-grid"),
                              success: function(data){
                                $("#dialog").html(data);
                                $("#dialog").dialog("option", "title", "'. Yii::t('application','View {title}', array('{title}'=>Yii::t('application', 'cczone'))) .' - " + $.fn.yiiGridView.getSelection("cczone-grid"));
                                $("#dialog").dialog("option", "height", "auto");
                                $("#dialog").dialog("option", "width", "auto");
                                $("#dialog").dialog("open"); 
                                return false;

...
<h2 style="text-align: center"><?php echo Yii::t('application', 'Wardwise Demand Report Subtitle1'); ?></h2>
...
<table border="1" cellspacing="0" cellpading="0" width="100%">
    ...
    <?php endforeach; ?>
    <tr style="background-color: lightgrey;">
        <td colspan="5" style="text-align: right;font-weight: bolder;font-size: 120%;">

...
<script>
    ...
    function generate(){
    	...
    	window.open("<?php echo Yii::app()->createUrl('report/transactionReport') ;?>&startdate=" + $("#from").val() + "&enddate=" + $("#to").val());
    	$("#from").val("");
    	$("#to").val("");    	
    }
...
<?php
	$this->setPageTitle(Yii::t('application', "Propertytax Received Amount"));
?>

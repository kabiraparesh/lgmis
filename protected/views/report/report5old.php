...
<table border="1" cellspacing="0" cellpading="0" width="100%">
    <tr style="background-color: lightgrey;">
        ...
        <th class="amount" width="13%">
            <?php echo Yii::t('application', 'propertytax_demand'); ?>
        </th>
        <th class="amount" width="13%">
            <?php echo Yii::t('application', 'propertytax_outstanding'); ?>
        </th>
        <th class="amount" width="13%">
        ...
        <th class="amount" width="13%">
            <?php echo Yii::t('application', 'minsamekittax_outstanding'); ?>
        </th>
        <th class="amount" width="13%">
            <?php echo Yii::t('application', 'Total Balance'); ?>
        </th>
    ...
    <tr>
        ...
        <td class="amount">
            <?php echo $ward['propertytax_outstanding']; ?>
        </td>
        <td class="amount highlight">
            <?php echo $ward['propertytax_total']; ?>
        </td>
        <td class="amount">
            <?php echo $ward['minsamekittax_demand']; ?>
        </td>
        <td class="amount">
            <?php echo $ward['minsamekittax_outstanding']; ?>
        </td>
        <td class="amount highlight">
            <?php echo $ward['minsamekittax_total']; ?>
        </td>
        <td class="amount highlight">
            <?php echo $ward['total']; ?>
        </td>
    ...
    <tr>
        ...
        <td class="amount highlight">
            <?php echo $propertytax_outstanding_summary; ?>
        </td>
        <td class="amount highlight">
            <?php echo $propertytax_demand_summary; ?>
        </td>
        ...
        <td class="amount highlight">
            <?php echo $minsamekittax_outstanding_summary; ?>
        </td>
        <td class="amount highlight">
            <?php echo $minsamekittax_demand_summary; ?>
        </td>

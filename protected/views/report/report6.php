...
<p style="padding: 0; margin: 0; font-weight: bold; text-align: center;"><?php echo Yii::t('application', 'Ccward') ?> - <?php echo $wardno; ?>&nbsp;<?php echo Yii::t('application', 'New Property') ?>&nbsp;<?php echo Yii::t('application', 'Propertytax Register') ?>&nbsp;<?php echo Yii::t('application', 'Idccfyear') ?>: <?php echo Yii::app()->session['ccfyear']->fyear; ?></p>
<br/>
...
//        $grandcurrenttotal = $demandsdetail['demand']['data'][0][2] + $demandsdetail['demand']['data'][1][2] + $demandsdetail['demand']['data'][2][2] + $demandsdetail['demand']['data'][9][2] + $demandsdetail['demand']['data'][3][2] + $demandsdetail['demand']['data'][4][2] + $demandsdetail['demand']['data'][5][2];
    ...
    <tr>
        ...
        <td width="4%">
            ...
            echo '/';
            echo $demandsdetail['ptmaster']->ledgerno; ?>&nbsp;
        </td> 
        <td width="4%">
